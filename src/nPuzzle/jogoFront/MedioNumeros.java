...
public class MedioNumeros extends Medio implements KeyListener {
	...
	private ImageIcon ajudaImg = new ImageIcon(getClass().getResource("/imagens/ajudaN2.jpg"));
	private Ranking rank = new Ranking(this.user);
	
	@ Override
	public void atualizar() {
		e11.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(0)));
		e12.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(1)));
		e13.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(2)));
		e14.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(3)));
		e21.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(4)));
		e22.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(5)));
		e23.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(6)));
		e24.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(7)));
		e31.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(8)));
		e32.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(9)));
		e33.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(10)));
		e34.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(11)));
		e41.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(12)));
		e42.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(13)));
		e43.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(14)));
		e44.setText(String.valueOf(telIni.getMovN().getPeças().getNumeros2().get(15)));
	...
	public MedioNumeros(String user) {
	...
	public void keyTyped(KeyEvent e) {
		...
		telIni.getMovN().repetiçao2();
		
		if(e.getKeyChar() == 'w') {
			telIni.getMovN().moverPeça2("W");
			this.atualizar();
		} else if(e.getKeyChar() == 's') {
			telIni.getMovN().moverPeça2("S");
			this.atualizar();
		} else if(e.getKeyChar() == 'a') {
			telIni.getMovN().moverPeça2("A");
			this.atualizar();
		} else if(e.getKeyChar() == 'd') {
			telIni.getMovN().moverPeça2("D");
			this.atualizar();
		}
	}
	...
	public void actionPerformed(ActionEvent e) { // botar movimento aki
		...
		if(e.getSource() != salvar && e.getSource() != ajuda) {
			...
			Save save = new Save(this.user,telIni.getMovN().getJogadas(),telIni.getMovN().getPeças().getNumeros2(),null,null);
			try {
				save.salvar();
